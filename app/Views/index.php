        ...
        <div class="classy-nav-container dark breakpoint-off">
            <div class="container">
                ...
                <nav class="classy-navbar justify-content-between" id="dreamNav">
                    ...
                    <!-- Logo -->
                    <a class="nav-brand" href="index-2.php"><img src="img/core-img/logo.png" alt="logo"> CV Builder.</a>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="who-we-contant mt-s">
                        ...
                        <a class="btn dream-btn mt-30" href="templates.php">lets build your cv</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="subscribe">
            <div class="row align-items-center relative">
                ...
                <div class="col-lg-3 col-lg-offset-1 col-md-3 col-sm-12 text-center">
                    <a href="contact-us.php" class="button mt-s">Send a Request</a>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_price_table_content wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="table_text_details">
                            ...
                            <a href="contact-us.php" class="button mt-s">Get Started</a>
                        </div>
                    </div>
                </div>
                <!-- Single Table -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="demo-item">
                        <a href="template-preview.php"><img src="img/demos/demo-1.png" alt="demo" class="img-responsive"></a>
                        <div class="preview-btn-wrapper text-center">
                            <a href="template-preview.php" class="preview-demo">See template <i class="fa fa-long-arrow-right"></i></a>
                            <a href="template-edit.php" class="preview-demo v2">Use template <i class="fa fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="demo-item">
                        <a href="template-preview.php"><img src="img/demos/demo-2.png" alt="demo" class="img-responsive"></a>
                        <div class="preview-btn-wrapper text-center">
                            <a href="template-preview.php" class="preview-demo">See template <i class="fa fa-long-arrow-right"></i></a>
                            <a href="template-edit.php" class="preview-demo v2">Use template <i class="fa fa-long-arrow-right"></i></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="demo-item">
                        <a href="template-preview.php"><img src="img/demos/demo-3.png" alt="demo" class="img-responsive"></a>
                        <div class="preview-btn-wrapper text-center">
                            <a href="template-preview.php" class="preview-demo">See template <i class="fa fa-long-arrow-right"></i></a>
                            <a href="template-edit.php" class="preview-demo v2">Use template <i class="fa fa-long-arrow-right"></i></a>
                        </div>
